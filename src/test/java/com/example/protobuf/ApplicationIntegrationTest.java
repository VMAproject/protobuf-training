...
@SpringBootTest(classes = ProtobufApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
public class ApplicationIntegrationTest {
	...
	private void assertResponse(String response) {
		...
		assertThat(response, containsString("john.doe@test.com"));
		assertThat(response, containsString("richard.roe@test.com"));
		assertThat(response, containsString("jane.doe@test.com"));
